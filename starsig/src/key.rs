...
//!
//! This module provides the [`SigningKey`] and [`VerificationKey`] types and associated methods.
...
impl VerificationKey {
    ...
    /// Constructs a VerificationKey from a private key, returning the decompressed point.
...
impl From<VerificationKey> for CompressedRistretto {
    fn from(val: VerificationKey) -> Self {
        val.into_point()
    }
}
