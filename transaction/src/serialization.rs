...
//     pub fn from_bytes(sig: impl AsRefExt) -> Result<Self, ElGamalSigError> {
//         let sig = sig.as_ref_ext();
//         if sig.len() != 64 {
//             return Err(ElGamalSigError::InvalidSignature);
//         }
//         let mut rbuf = [0u8; 32];
//         let mut sbuf = [0u8; 32];
...
//             s: Scalar::from_canonical_bytes(sbuf).ok_or(ElGamalSigError::InvalidSignature)?,
//         })
//     }
